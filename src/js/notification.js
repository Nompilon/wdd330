...
export const NotificationModule = (() => {
  ...
  function checkNutrientGoals() {
    ...
    if (totals.calories > goals.calories)
      alerts.push("You've exceeded your daily calorie goal!");
    if (totals.protein < goals.protein * 0.5)
      alerts.push("You should eat more protein today!");
    if (totals.carbs < goals.carbs * 0.5)
      alerts.push("Consider adding more carbs to reach your goal!");
    if (totals.fat < goals.fat * 0.5)
      alerts.push("You need more fats to meet your daily goal!");
  ...
  function showNotification(message) {
    ...
    if (Notification.permission === "granted") {
      new Notification("NutriTrack Hub Reminder", {
        body: message,
        icon: "images/nutrition_icon_136342.svg",
      });
